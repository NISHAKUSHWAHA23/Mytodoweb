...
<body>
    ...
    <div class="container">
        ...
        <h1 class="p-3"> Today Activities</h1>
        <h3 class="p-3">Manage your habits,reminders,events</h3>
            	...
            	<c:forEach var="todo" items="${list}">
                    <tr>
                		...
                		<td><button type="button" class="btn btn-success">
                		    <a href="/updateToDoStatus/${todo.id}">I have Done</a>
                		</button></td>
                		<td><button type="button" class="btn btn-primary">
                		    <a href="/editToDoItem/${todo.id}">Add My new choice</a>
                		</button></td>
        ...
        <button type="button" class="btn btn-primary btn-block">
        	<a href="/addToDoItem">your new activities</a>
        </button>
